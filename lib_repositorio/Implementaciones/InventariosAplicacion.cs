...
namespace lib_repositorio.Implementaciones
{
    public class InventariosAplicacion : IInventariosAplicacion
    {
        ...
        public Inventarios? Borrar(Inventarios? entidad)
        {
            ...
            {
                Fecha = DateTime.Now,
                Descripcion = $"Se elimino el elemento {entidad.Id}"
            });
        ...
        public Inventarios? Guardar(Inventarios? entidad)
        {
            ...
            {
                Fecha = DateTime.Now,
                Descripcion = $"Se creó el elemento {entidad.Id}"
            });
        ...
        public Inventarios? Modificar(Inventarios? entidad)
        {
            ...
            {
                Fecha = DateTime.Now,
                Descripcion = $"Se modifico el elemento {entidad.Id}"
            });
        ...
        public List<Inventarios> PorDescripcion(Inventarios? entidad)
        {
