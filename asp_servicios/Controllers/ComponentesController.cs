...
namespace asp_servicios.Controllers
{
    ...
    {
        [HttpPost]
        public IEnumerable<Componentes> Get()
        {
        ...
        private ComponentesAplicacion? iAplicacion;
        public ComponentesController(ComponentesAplicacion? iAplicacion/*, TokenController tokenController*/)
        {
        ...
        public string Guardar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Componentes>(
