...
namespace asp_servicios.Controllers
{
    ...
    {
        [HttpPost]
        public IEnumerable<Computadores> Get()
        {
            ...
            return new List<Computadores>();
        }

        private ComputadoresAplicacion? iAplicacion;
        public ComputadoresController(ComputadoresAplicacion? iAplicacion/*, TokenController tokenController*/)
        {
        ...
        public string Guardar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Computadores>(
