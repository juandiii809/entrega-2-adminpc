...
namespace asp_servicios.Controllers
{
    ...
    {
        [HttpPost]
        public IEnumerable<Inventarios> Get()
        {
        ...
        private InventariosAplicacion? iAplicacion;
        public InventariosController(InventariosAplicacion? iAplicacion/*, TokenController tokenController*/)
        {
