...
namespace asp_servicios.Controllers
{
    ...
    {
        [HttpPost]
        public IEnumerable<Garantias> Get()
        {
        ...
        private GarantiasAplicacion? iAplicacion;
        public GarantiasController(GarantiasAplicacion? iAplicacion/*, TokenController tokenController*/)
        {
        ...
        public string Guardar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Garantias>(
